# -*- coding: utf-8 -*-
#
# aws_lbd_art_builder_core documentation build configuration file, created by
...
package_name = "aws_lbd_art_builder_core"
...
# Add data for Jinja2
try:
    from aws_lbd_art_builder_core.docs import doc_data
except:
    doc_data = dict()
